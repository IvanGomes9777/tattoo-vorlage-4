...
export default function Datenschutz() {
  return (
    <LegalShell title="Datenschutzerklärung" updated="Juni 2026">
      ...
      <section>
        <h2 className="font-display text-xl text-cream">5. Google Maps</h2>
        <p>
      ...
      <section>
        <h2 className="font-display text-xl text-cream">6. Hosting</h2>
        <p>
      ...
      <section>
        <h2 className="font-display text-xl text-cream">7. Deine Rechte</h2>
        <p>
